...
export default function ButtonWithIcon({ type, onClick, disabled }) {
  const STYLES = {
    base: "flex justify-center items-center gap-2 py-2 px-4 w-full transition ease-in duration-200 focus:outline-none enabled:focus:ring-2 enabled:focus:ring-offset-2 enabled:active:scale-90 disabled:cursor-not-allowed",
    shadow: "shadow-md",
    shape: "rounded-full",
    color:
