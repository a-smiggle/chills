import Timeline from "@snippets/Timeline/v1TS";
  ...
  return (
    <Layout>
      <div className="flex flex-col p-4">
        <h1 className="pb-4 text-2xl font-semibold">Timeline V1</h1>
          ...
          <Timeline
            data={[
              ...
              },
              {
                ...
                body: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque scelerisque diam non nisi semper, et elementum lorem ornare. Maecenas placerat facilisis mollis. Duis sagittis ligula in sodales vehicula.",
                action: (
                  <button className="flex w-fit cursor-pointer items-center justify-center gap-2 rounded border border-emerald-500 bg-emerald-300 px-4 py-2 text-lg font-semibold transition-colors duration-300 hover:bg-emerald-500 hover:text-white active:scale-90 disabled:scale-100 disabled:cursor-not-allowed">
                    Read More
                  </button>
                ),
              },
