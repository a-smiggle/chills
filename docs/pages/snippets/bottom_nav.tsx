import BottomNav from "@snippets/BottomNav/BottomNavTS";
  ...
  return (
    <Layout>
      <div className="flex w-full flex-col p-4">
        <h1 className="pb-4 text-2xl font-semibold">Bottom Nav</h1>
        <p className="pb-4">Creates an easy to use Bottom Nav component.</p>
        <p className="pb-4">
        ...
        <ul>
          <li>ch-bottomNav</li>
          <li>ch-bottomNavTS</li>
        </ul>
        <br />
        <h2 className="py-4 text-xl font-medium">Props</h2>
        <p>Bottom Nav takes the following props:</p>
        <ul>
          <li>data: BottomNavType[]</li>
          <li>absolute: boolean</li>
        </ul>
        <br />
        <p>BottomNavType contains the following:</p>
        <ul>
          <li>title: string</li>
