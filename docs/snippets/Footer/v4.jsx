...
export default function Footer() {
  return (
    <footer className="w-full min-h-[4rem] py-4 px-4 md:px-8 gap-8 md:gap-0 bg-white dark:bg-slate-800 text-black dark:text-slate-300 shadow-inner flex flex-col justify-between divide-y-2">
