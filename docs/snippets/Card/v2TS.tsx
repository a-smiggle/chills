...
export default function Card({
  ...
  if (loading)
    return (
      <div className="h-[28rem] w-96 rounded border border-black bg-white shadow-lg dark:border-slate-300 dark:bg-slate-800">
        <div className="h-1/2 w-full animate-pulse rounded-t bg-slate-300"></div>
  ...
  return (
    <div className="flex h-fit max-h-[28rem] w-96 flex-col rounded border border-black bg-white text-black shadow-lg dark:border-slate-300 dark:bg-slate-800 dark:text-slate-300">
